...
from blockcypher.api import (create_unsigned_tx, verify_unsigned_tx,
...
def not_simple_spend(from_privkey, to_addresses, to_satoshis,
                     change_address=None, privkey_is_compressed=True,
                     min_confirmations=0, api_key=None, coin_symbol='btc'):
    '''
